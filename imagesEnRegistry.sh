...
docker build -t localhost:5000/tablon-web:1.0   ./app
docker build -t localhost:5000/tablon-nginx:1.0 ./nginx

echo "==> Subiendo imágenes al registry..."
docker push localhost:5000/tablon-web:1.0
docker push localhost:5000/tablon-nginx:1.0
